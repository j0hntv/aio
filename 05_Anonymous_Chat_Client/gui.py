...
async def draw(messages_queue, sending_queue, status_updates_queue):
    ...
    async with create_task_group() as task_group:
        ...
        await task_group.spawn(update_conversation_history, conversation_panel, messages_queue)
        await task_group.spawn(update_status_panel, status_labels, status_updates_queue)
